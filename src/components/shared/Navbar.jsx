...
export function Navbar() {
  ...
  return (
    <header className="bg-white border-b border-gray-200 sticky top-0 z-50">
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between gap-4 sm:gap-8">
        ...
        {/* Links centrais */}
        <nav className="flex items-center gap-1 overflow-x-auto no-scrollbar flex-1 min-w-0 px-2 sm:px-0">
        ...
        <div className="flex items-center gap-3 shrink-0">
          <NavLink
            to="/perfil"
            className="hidden sm:block text-sm text-gray-600 hover:text-gray-900 font-medium transition-colors truncate max-w-[100px]"
          >
            {profile?.name ?? 'Atleta'}
          </NavLink>
